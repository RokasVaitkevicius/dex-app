...
contract Exchange is ERC20 {
    ...
    function addLiquidity(uint256 amountOfTokens) public payable returns(uint256) {
        ...
        require(amountOfTokens >= minTokenAmountRequired, "Insufficient amount of tokens provided");
    ...
    function getOutputAmountFromSwap(uint256 inputAmount, uint256 inputReserve, uint256 outputReserve) public pure returns (uint256) {
        require(inputReserve > 0 && outputReserve > 0, "Input and output reserves must be greater than 0");
